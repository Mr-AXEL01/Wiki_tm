        ...
        <div class="flex-1 flex flex-wrap">
            ...
            <div class="flex-1 p-4 w-full md:w-1/2">
                ...
                <div class="mt-8 md:flex jmd:ustify-rounded  space-x-0 space-y-2 md:space-x-4 md:space-y-0">
                    ...
                    <div class="flex-1 bg-yellow-300 p-4 shadow rounded-lg md:w-1/2">
                    ...
                    <div class="flex-1 bg-green-300 p-4 shadow rounded-lg md:w-1/2">
                ...
                <div class="mt-2 md:flex md:justify-rounded   space-x-0 space-y-2 md:space-x-4 md:space-y-0">
                    ...
                    <div class="flex-1 bg-red-300 p-4 shadow rounded-lg md:w-1/2">
                    ...
                    <div class="flex-1 bg-stone-400 p-4 shadow rounded-lg md:w-1/2">
                ...
                <div class="mt-8 bg-white p-4 shadow rounded-lg mx-auto min-h-1/2">
                    ...
                    <div class="my-1"></div>
                    <div class="bg-gradient-to-r from-black to-sky-900 h-px mb-6"></div>
