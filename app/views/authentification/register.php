...
<body class="font-sans bg-gray-100">
    <div class="font-[sans-serif] text-[#333]">
        <div class="text-center bg-gradient-to-r from-blue-800 to-black min-h-[260px] sm:p-6 p-4">
            <a href="../index.php"><h4 class="sm:text-3xl text-2xl font-bold text-white">Create your account to be an author</h4></a>
        </div>
    ...
    <script src="../../../public/js/regixRegister.js"></script>
</body>
